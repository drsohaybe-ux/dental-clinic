...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("doctor_name_fr", sa.String(length=150), nullable=False, server_default="Dr. Chirurgien Dentiste"),
        sa.Column("doctor_specialty_fr", sa.String(length=150), nullable=False, server_default="Chirurgien Dentiste"),
        sa.Column("doctor_name_ar", sa.String(length=150), nullable=False, server_default="الدكتور جراح أسنان"),
        sa.Column("doctor_specialty_ar", sa.String(length=150), nullable=False, server_default="جراح أسنان"),
        sa.Column("city", sa.String(length=100), nullable=False, server_default="Alger"),
