...
TREATMENTS: dict[str, list[dict[str, Any]]] = {
    ...
    "restauradora": [
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("16000.00"),
            "default_duration_minutes": 60,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
            "odontogram_treatment_type": "inlay",
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("32000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "per_tooth",
            "odontogram_treatment_type": "crown",
        ...
        # Puentes (per_role pricing)
        {
            ...
            "pricing_config": {"pillar": 18000, "pontic": 14000},
        ...
        },
        {
            ...
            "vat_type": "exempt",
            "pricing_strategy": "per_role",
            "pricing_config": {"pillar": 32000, "pontic": 25000},
            "odontogram_treatment_type": "bridge",
        ...
        },
        {
            ...
            "vat_type": "exempt",
            "pricing_strategy": "per_role",
            "pricing_config": {"pillar": 20000, "pontic": 15000},
            "odontogram_treatment_type": "bridge",
    ...
    "periodoncia": [
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("22000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("28000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
    ...
    "cirugia": [
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("75000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "per_tooth",
            "odontogram_treatment_type": "implant",
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("95000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "per_tooth",
            "odontogram_treatment_type": "implant",
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("40000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
        ...
        },
        {
            ...
            "treatment_scope": "tooth",
            "default_price": Decimal("30000.00"),
            "default_duration_minutes": 90,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
    ...
    "ortodoncia": [
        ...
        },
        {
            ...
            "treatment_scope": "global_mouth",
            "default_price": Decimal("160000.00"),
            "default_duration_minutes": 60,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
        ...
        },
        {
            ...
            "treatment_scope": "global_mouth",
            "default_price": Decimal("180000.00"),
            "default_duration_minutes": 45,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
        {
            ...
            "treatment_scope": "global_mouth",
            "default_price": Decimal("280000.00"),
            "default_duration_minutes": 45,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
    ...
    "protesis": [
        ...
        },
        {
            ...
            "treatment_scope": "global_arch",
            "default_price": Decimal("90000.00"),
            "default_duration_minutes": 120,
            "vat_type": "exempt",
            "pricing_strategy": "flat",
        },
...
async def seed_clinic_defaults(db: AsyncSession, clinic_id: UUID) -> dict:
    ...
    # Reference prices are Algerian DZD figures (or EUR).
    return await seed_catalog(
        db,
        clinic_id,
        vat_preset=get_preset(country).vat_preset,
        with_prices=clinic.currency in ("EUR", "DZD"),
    )
